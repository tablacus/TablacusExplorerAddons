...
if (window.Addon == 1) {
	...
	var s = ['<span class="button" onmousedown="Addons.ControlPanelButton.Open(this); return false;" onmouseover="MouseOver(this)" onmouseout="MouseOut()"><img title="Control Panel" src="', EncodeSC(src), '" style="width:"', h, 'px; height:"', h, 'px"></span>'];
