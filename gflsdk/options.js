...
for (var i = 32; i <= 64; i += 32) {
	s.push('<div class="panel" style="width: 100%; display: block"><table style="width: 100%"><tr><td style="width: 100%; vertical-align: bottom"><label>libgfl*.dll (', i, 'bit)</label></td>');
	s.push('<td><input type="button" value="Portable" onclick="PortableX(\'dll', i, '\')" /></td><td><input type="button" value="Browse..." onclick="RefX(\'dll', i, '\', 0, 0, 1, \'Dll Files|*.dll\')" /></td></tr></table>');
	s.push('<td><input type="text" name="dll', i, '" style="width: 100%" onchange="SetProp()" /></div>');

	s.push('<div class="panel" style="width: 100%; display: block"><table style="width: 100%"><tr><td style="width: 100%; vertical-align: bottom"><label>libgfle*.dll (', i, 'bit)</label></td>');
	s.push('<td><input type="button" value="Portable" onclick="PortableX(\'dlle', i, '\')" /></td><td><input type="button" value="Browse..." onclick="RefX(\'dlle', i, '\', 0, 0, 1, \'Dll Files|*.dll\')" /></td></tr></table>');
