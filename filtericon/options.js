...
var arIndex = ["Filter", "Small", "Large"];
var fnConfig = fso.BuildPath(te.Data.DataFolder, "config\\filtericon.tsv");
...
function SaveIC(mode)
{
	if (g_Chg[mode]) {
		...
		ado.SaveToFile(fso.BuildPath(te.Data.DataFolder, "config\\filtericon.tsv"), adSaveCreateOverWrite);
		ado.Close();
	}
}
...
{
	var image = Addons.FilterIcon.GetIconImage(document.E.elements[s].value, i);
