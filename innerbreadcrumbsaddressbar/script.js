		...
		Arrange: async function (FolderItem, Id) {
			...
			if (FolderItem) {
				...
				for (n = 0; n < Items.length; ++n) {
					...
					arHTML.unshift('<span id="breadcrumbsaddressbar_' + Id + "_" + n + '_" class="button" style="line-height: ' + height + 'px" onmouseover="MouseOver(this)" onmouseout="Addons.InnerBreadcrumbsAddressBar.Out1(event, this)" oncontextmenu="Addons.InnerBreadcrumbsAddressBar.Exec(' + Id + '); return false;">' + EncodeSC(Items[n].name) + '</span>');
