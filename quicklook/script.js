...
if (window.Addon == 1) {
	...
	SetAddon(Addon_Id, Default, ['<span class="button" onclick="Addons.QuickLook.Exec(this)" onmouseover="MouseOver(this)" onmouseout="MouseOut()">', await GetImgTag({ title: item.getAttribute("MenuName") || await GetAddonInfo(Addon_Id).Name, src: s }, h), '</span>']);
