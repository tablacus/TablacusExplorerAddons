...
if (window.Addon == 1) {
	...
	SetAddon(Addon_Id, Default, ['<input type="text" name="everythingsearch" placeholder="Everything" onkeydown="return Addons.Everything.KeyDown(this)" onmouseup="Addons.Everything.Change(this)" onfocus="Addons.Everything.Focus(this)" onblur="Addons.Everything.ShowButton()" style="width:', EncodeSC(width), '; padding-right:', WINVER < 0x602 ? "24" : "12", 'pt; vertical-align: middle"><span style="position: relative"><span id="ButtonEverythingClear" src="bitmap:ieframe.dll,545,13,1" onclick="Addons.Everything.Clear()" class="button" style="font-family: marlett; font-size: 7pt; display: none; position: absolute; left: -21pt; top: 3pt">r</span><input type="image" src="', EncodeSC(icon), '" onclick="Addons.Everything.Search()" hidefocus="true" style="position: absolute; left: -13.5pt; top: 1pt; width 12pt; height: 12pt"></span>'], "middle");
} else {
