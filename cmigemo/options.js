...
for (var i = 32; i <= 64; i += 32) {
	s.push('<div class="panel" style="width: 100%; display: block"><table style="width: 100%"><tr><td style="width: 100%; vertical-align: bottom"><label>migemo.dll (', i, 'bit)</label></td>');
	s.push('<td><input type="button" value="Portable" onclick="PortableX(\'dll', i, '\')" /></td><td><input type="button" value="Browse..." onclick="RefX(\'dll', i, '\', 0, 0, 1)" /></td></tr></table>');
